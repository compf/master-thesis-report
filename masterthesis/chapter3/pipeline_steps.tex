...
The handler should take care that it only finds data clumps, and not related part of the source code. For instance, finding where a data clump method is called is not part of this steps and should ne be saved yet. 
