...
Another metric for the evaluation could the running time. A huge running time of the refactoring can slow down the development process and cause the program not to be used again for future iterations. 
