...
Since a service-based approach is used, a handler can be as a gateway to a different program or service that performs the specific functionality. 
\begin{figure}
    \centering
...
\begin{enumerate}
    \item The probram devloped in this master thesis executes one step (e.g. finding a suitable class name)
